...
public class FinalSmokeChange{
	...
	@Test(priority=0,description="Creation,Approval of chnage ticket and Moving the Change to Multiple phase",enabled=true)
	...
	@Test(priority=1,description="Cancel Change ticket",enabled=true)
...
@Test(priority=3,description="creating and updating and moving the change task to different state and validating the closure of change task",enabled=false)
	
	public void testTaskMovingtoMultiplePhases() throws Exception{
	
	logger = extent.createTest("Moving to multiple phases");
	String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
	System.setProperty("webdriver.gecko.driver",FirefoxDriver);
	WebDriver driver=new FirefoxDriver();
...
@Test(priority=4,description="Cancel change task",enabled=false)

public void testCancelChangeTask() throws Exception{

logger = extent.createTest("Cancel change task");
String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
System.setProperty("webdriver.gecko.driver",FirefoxDriver);
WebDriver driver=new FirefoxDriver();
...
@Test(priority=5,description="Update change ticket",enabled=true)
public void testUpdateChangeTicket() throws Exception{
	logger = extent.createTest("Update change ticket");
	String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
	System.setProperty("webdriver.gecko.driver",FirefoxDriver);
	WebDriver driver=new FirefoxDriver();
...
@Test(priority=6,description="Default task validation",enabled=true)
...
@Test(priority=7,description="Follow up clicked list view",enabled=true)
...
@Test(priority=11,description="testValidateMandatoryChangeTask",enabled=false)

public void testValidateMandatoryChangeTask() throws Exception{

logger = extent.createTest("testValidateMandatoryChangeTask");
String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
System.setProperty("webdriver.gecko.driver",FirefoxDriver);
WebDriver driver=new FirefoxDriver();
...
@Test(priority=12,description="change task partial closed",enabled=false)

public void testChangeTaskPartiallClose() throws Exception{

logger = extent.createTest("change task partial closed");
String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
System.setProperty("webdriver.gecko.driver",FirefoxDriver);
WebDriver driver=new FirefoxDriver();
...
@Test(priority=13,description="Change task unsuccessfull close",enabled=false)

public void testChangeTaskUnsuccessfulllClose() throws Exception{

logger = extent.createTest("Change task unsuccessfull close");
String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
System.setProperty("webdriver.gecko.driver",FirefoxDriver);
WebDriver driver=new FirefoxDriver();
...
@Test(priority=14,description="test close task and cancel task buttons are available in the change task",enabled=false)

public void testCloseAndCancell() throws Exception{

logger = extent.createTest("test close task and cancel task buttons are available in the change task");
String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
System.setProperty("webdriver.gecko.driver",FirefoxDriver);
WebDriver driver=new FirefoxDriver();
...
@Test(priority=15,description="Reject CR ticket to close",enabled=false)
public void testChangeTicketRejectClose() throws IOException, InterruptedException{
	//ExtentReport.startReport(Capabilities.getPropertyValue("ChangeReports"), "SmokeChangeTest1", "Reject Change Ticket Report");
	logger = extent.createTest("Reject CR ticket to close");
	String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
	System.setProperty("webdriver.gecko.driver",FirefoxDriver);
	WebDriver driver=new FirefoxDriver();
	driver.get("http://thomsonreutersqa.service-now.com");
...
@Test(priority=16,description="test copy change, submit for planning ,cancel change buttons are avialable",enabled=false)
public void testCopyChangeAnSubmitForPlanningButtons() throws IOException, InterruptedException{
	
	logger = extent.createTest("test copy change, submit for planning ,cancel change buttons are avialable");
	String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
	System.setProperty("webdriver.gecko.driver",FirefoxDriver);
	WebDriver driver=new FirefoxDriver();
...
@Test(priority=17,description="Save and submit buttons are available in the form",enabled=false)
public void testSaveAndSubmitButtons() throws IOException, InterruptedException{
	
	logger = extent.createTest("Save and submit buttons are available in the form");
	String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
	System.setProperty("webdriver.gecko.driver",FirefoxDriver);
	WebDriver driver=new FirefoxDriver();
...
@Test(priority=18,description="Planned start and end dates validations",enabled=false)
...
@Test(priority=19,description="Reject and approve button validations",enabled=false)
public void testRejectAndApproveButtons() throws Exception{
	logger = extent.createTest("Reject and approve button validations");
	String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
	System.setProperty("webdriver.gecko.driver",FirefoxDriver);
	WebDriver driver=new FirefoxDriver();
...
@Test(priority=20,description="Complete implementation button validation",enabled=false)
...
logger = extent.createTest("Close assessment button validations");
String FirefoxDriver = Capabilities.getPropertyValue("FirefoxDriver");
System.setProperty("webdriver.gecko.driver",FirefoxDriver);
WebDriver driver=new FirefoxDriver();
